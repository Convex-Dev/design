...
Ready-to-cook examples you can run in the Sandbox or against the public testnet. Recipes use short code snippets but are meant to be accessible even if you are new to coding — don't be afraid to try them out. New to Convex? Start with the [Quick Start](../quickstart.md) first.
...
|--------|----------------|
| [Create an Account](create-account/index.md) | Generate a key pair and create your own Convex account |
