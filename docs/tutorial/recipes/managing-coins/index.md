...
Here the coin supply is the one million Convex Coins issued at genesis, plus a small amount of transaction fees incurred by governance accounts. Normal transaction fees by non-governance do not affect the coin supply (since they are re-circulated).
