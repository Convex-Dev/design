...
def main():
    ...
    print(f'Transferred 0.01 CVM to #{recipient.address}')
...
Convex is building the future of decentralised economies - fair, inclusive, and sustainable systems powered by lattice technology. With Python and TypeScript SDKs, you can build on Convex in the language you already work in.
