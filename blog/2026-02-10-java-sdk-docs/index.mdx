...
- **High Performance** - JVM optimisation, native threads, efficient GC
...
Convex is building the future of decentralised economies - fair, inclusive, and sustainable systems powered by lattice technology. With Java, Python, and TypeScript SDKs, you can build on Convex in the language you already work in.
